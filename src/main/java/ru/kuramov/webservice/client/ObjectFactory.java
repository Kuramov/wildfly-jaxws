 ...
 * generated in the ru.kuramov.webservice.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorldFrom_QNAME = new QName("http://ru.kuramov.wildfly.jaxws.service/", "sayHelloWorldFrom");
    private final static QName _SayHelloWorldFromResponse_QNAME = new QName("http://ru.kuramov.wildfly.jaxws.service/", "sayHelloWorldFromResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.kuramov.webservice.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ru.kuramov.wildfly.jaxws.service/", name = "sayHelloWorldFrom")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ru.kuramov.wildfly.jaxws.service/", name = "sayHelloWorldFromResponse")
